...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (summarye haml-mode lua-mode twittering-mode ace-link yaml-mode magit undo-tree iedit ## browse-kill-ring markdown-mode htmlize cask bind-key auto-complete)))
