...
alias c='chatgpt'
alias c='chatgpt'
alias ai='AIDER_CWD=$PWD aider --subtree-only --no-auto-commits --dark-mode --model claude-3-7-sonnet-20250219 --cache-prompts'
# alias ai='AIDER_CWD=$PWD aider --subtree-only --no-auto-commits --dark-mode --model claude-3-5-sonnet-latest'
alias aio='AIDER_CWD=$PWD aider --subtree-only --no-auto-commits --dark-mode --model gpt-4o --cache-prompts'
alias ar='airun'
